package com.run.sg.amap3d.share;
...
public class ShareActivity extends Activity implements OnClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.share_activity);
		mMapView = (MapView) findViewById(com.run.sg.amap3d.R.id.map);
		mMapView.onCreate(savedInstanceState);// 此方法必须重写
		mLocationButton = (Button) findViewById(com.run.sg.amap3d.R.id.share_location);
		mRouteButton = (Button) findViewById(com.run.sg.amap3d.R.id.share_route);
		mPoiButton = (Button) findViewById(com.run.sg.amap3d.R.id.share_poi);
		mNaviButton = (Button) findViewById(com.run.sg.amap3d.R.id.share_navi);
		mUrlView = (WebView)findViewById(com.run.sg.amap3d.R.id.url_view);
	...
	public void onClick(View v) {
		...
		int viewID = v.getId();
		switch (viewID) {
		case com.run.sg.amap3d.R.id.share_poi: {
			String title = "高德软件有限公司";
			String snippet = "方恒国际中心A座";
			sharePOI(title, snippet);
			break;
		}
		case com.run.sg.amap3d.R.id.share_location: {
			String snippet = "方恒国际中心A座";
			shareLocation(snippet);
			break;
		}
		case com.run.sg.amap3d.R.id.share_route: {
			shareRoute();
			break;
		}
		case com.run.sg.amap3d.R.id.share_navi: {
			shareNavi();
			break;
		}
		}
	...
	private void addTestLocationMarker(String snippet) {
		...
		addMarker(POI_POINT.getLatitude(), POI_POINT.getLongitude(), title,
				...
				BitmapDescriptorFactory
						.fromResource(com.run.sg.amap3d.R.drawable.location_marker));
		LatLng latlng = new LatLng(POI_POINT.getLatitude(),
				POI_POINT.getLongitude());
		mAMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latlng, 18));
	}
	...
	private void addRouteMarker() {
		...
		addMarker(START.getLatitude(), START.getLongitude(), "", "",
				BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.start));
		addMarker(END.getLatitude(), END.getLongitude(), "", "",
				BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.end));
