...
private AutoCompleteTextView mKeywordText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.run.sg.amap3d.R.layout.subpoisearch_activity);
        mPoiSearchList = (ListView)findViewById(com.run.sg.amap3d.R.id.listView);
        mKeywordText = (AutoCompleteTextView)findViewById(com.run.sg.amap3d.R.id.keyword);
        mKeywordText.addTextChangedListener(this);
        mSearchbtn = (Button)findViewById(com.run.sg.amap3d.R.id.search_btn);
