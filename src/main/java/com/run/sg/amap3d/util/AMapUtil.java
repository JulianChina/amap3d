 ...
 * 
 */
package com.run.sg.amap3d.util;
	...
	//路径规划方向指示和图片对应
		public static int getDriveActionID(String actionName) {
			if (actionName == null || actionName.equals("")) {
				return com.run.sg.amap3d.R.drawable.dir3;
			}
			if ("左转".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir2;
			}
			if ("右转".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir1;
			}
			if ("向左前方行驶".equals(actionName) || "靠左".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir6;
			}
			if ("向右前方行驶".equals(actionName) || "靠右".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir5;
			}
			if ("向左后方行驶".equals(actionName) || "左转调头".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir7;
			}
			if ("向右后方行驶".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir8;
			}
			if ("直行".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir3;
			}
			if ("减速行驶".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir4;
			}
			return com.run.sg.amap3d.R.drawable.dir3;
		}
		...
		public static int getWalkActionID(String actionName) {
			if (actionName == null || actionName.equals("")) {
				return com.run.sg.amap3d.R.drawable.dir13;
			}
			if ("左转".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir2;
			}
			...
			if ("通过人行横道".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir9;
			}
			if ("通过过街天桥".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir11;
			}
			if ("通过地下通道".equals(actionName)) {
				return com.run.sg.amap3d.R.drawable.dir10;
			}
