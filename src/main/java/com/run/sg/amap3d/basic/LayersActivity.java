...
public class LayersActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.layers_activity);
	    /*
	...
	private void init() {
		...
		CheckBox traffic = (CheckBox) findViewById(com.run.sg.amap3d.R.id.traffic);
		traffic.setOnClickListener(this);
		
		CheckBox buildings = (CheckBox) findViewById(com.run.sg.amap3d.R.id.building);
		buildings.setOnClickListener(this);
		
		CheckBox maptext = (CheckBox) findViewById(com.run.sg.amap3d.R.id.maptext);
	...
	public void onClick(View v) {
		if (v.getId() == com.run.sg.amap3d.R.id.traffic) {
			aMap.setTrafficEnabled(((CheckBox) v).isChecked());// 显示实时交通状况
		} else if (v.getId() == com.run.sg.amap3d.R.id.building) {
			aMap.showBuildings(((CheckBox) v).isChecked());// 显示3D 楼块
		} else if (v.getId() == com.run.sg.amap3d.R.id.maptext) {
