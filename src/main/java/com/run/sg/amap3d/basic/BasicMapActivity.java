...
public class BasicMapActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.basicmap_activity);
	    /*
	...
	private void init() {
		...
		basicmap = (Button)findViewById(com.run.sg.amap3d.R.id.basicmap);
		basicmap.setOnClickListener(this);
		rsmap = (Button)findViewById(com.run.sg.amap3d.R.id.rsmap);
		rsmap.setOnClickListener(this);
		nightmap = (Button)findViewById(com.run.sg.amap3d.R.id.nightmap);
		nightmap.setOnClickListener(this);
		navimap = (Button)findViewById(com.run.sg.amap3d.R.id.navimap);
		navimap.setOnClickListener(this);

		mStyleCheckbox = (CheckBox) findViewById(com.run.sg.amap3d.R.id.check_style);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case com.run.sg.amap3d.R.id.basicmap:
				aMap.setMapType(AMap.MAP_TYPE_NORMAL);// 矢量地图模式
				break;
			case com.run.sg.amap3d.R.id.rsmap:
				aMap.setMapType(AMap.MAP_TYPE_SATELLITE);// 卫星地图模式
				break;
			case com.run.sg.amap3d.R.id.nightmap:
				aMap.setMapType(AMap.MAP_TYPE_NIGHT);//夜景地图模式
				break;
			case com.run.sg.amap3d.R.id.navimap:
