...
public class MinMaxZoomLevelActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.run.sg.amap3d.R.layout.min_max_zoomlevel_activity);

        mapView = (MapView) findViewById(com.run.sg.amap3d.R.id.map);
        mapView.onCreate(savedInstanceState);
        init();

        textMinZoomLevel = (EditText) findViewById(com.run.sg.amap3d.R.id.text_min);
        textMaxZoomLevel = (EditText) findViewById(com.run.sg.amap3d.R.id.text_max);
        textCurrentLevel = (TextView) findViewById(com.run.sg.amap3d.R.id.text_current_level);
