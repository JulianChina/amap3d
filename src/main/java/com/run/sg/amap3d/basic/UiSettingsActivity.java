...
public class UiSettingsActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.ui_settings_activity);
		/*
	...
	private void init() {
		...
		CheckBox scaleToggle = (CheckBox) findViewById(com.run.sg.amap3d.R.id.scale_toggle);
		scaleToggle.setOnClickListener(this);
		CheckBox zoomToggle = (CheckBox) findViewById(com.run.sg.amap3d.R.id.zoom_toggle);
		zoomToggle.setOnClickListener(this);
		zoomRadioGroup = (RadioGroup) findViewById(com.run.sg.amap3d.R.id.zoom_position);
		zoomRadioGroup.setOnCheckedChangeListener(this);
		CheckBox compassToggle = (CheckBox) findViewById(com.run.sg.amap3d.R.id.compass_toggle);
		compassToggle.setOnClickListener(this);
		CheckBox mylocationToggle = (CheckBox) findViewById(com.run.sg.amap3d.R.id.mylocation_toggle);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		if (aMap != null) {
			if (checkedId == com.run.sg.amap3d.R.id.zoom_bottom_right) {
				mUiSettings
						.setZoomPosition(AMapOptions.ZOOM_POSITION_RIGHT_BUTTOM);
			} else if (checkedId == com.run.sg.amap3d.R.id.zoom_center_right) {
				mUiSettings
	...
	public void onClick(View view) {
		 ...
		 * 设置地图默认的比例尺是否显示
		 */
		case com.run.sg.amap3d.R.id.scale_toggle:
		 ...
		 * 设置地图默认的缩放按钮是否显示
		 */
		case com.run.sg.amap3d.R.id.zoom_toggle:
		 ...
		 * 设置地图默认的指南针是否显示
		 */
		case com.run.sg.amap3d.R.id.compass_toggle:
			mUiSettings.setCompassEnabled(((CheckBox) view).isChecked());
			break;
		/**
		 * 设置地图默认的定位按钮是否显示
		 */
		case com.run.sg.amap3d.R.id.mylocation_toggle:
