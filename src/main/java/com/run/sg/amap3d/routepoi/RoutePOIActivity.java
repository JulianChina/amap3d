package com.run.sg.amap3d.routepoi;
...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener, OnRoutePOISearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.run.sg.amap3d.R.layout.routepoi_activity);
	...
	private void init() {
		...
		gasbtn = (TextView)findViewById(com.run.sg.amap3d.R.id.gasbtn);
		ATMbtn= (TextView)findViewById(com.run.sg.amap3d.R.id.ATMbtn);
		Maibtn= (TextView)findViewById(com.run.sg.amap3d.R.id.Maibtn);
		Toibtn= (TextView)findViewById(com.run.sg.amap3d.R.id.Toibtn);
	}
		...
		if (errorCode == AMapException.CODE_AMAP_SUCCESS) {
			if(result != null){
				...
				if (items != null && items.size() > 0) {
					...
					ToastUtil.show(RoutePOIActivity.this, com.run.sg.amap3d.R.string.no_result);
				}
			}
		}else{
