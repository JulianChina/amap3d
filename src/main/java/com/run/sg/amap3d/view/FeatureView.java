...
package com.run.sg.amap3d.view;
...
public final class FeatureView extends FrameLayout {
	...
	public FeatureView(Context context) {
		...
		layoutInflater.inflate(com.run.sg.amap3d.R.layout.feature, this);
	}

	public synchronized void setTitleId(int titleId) {
		((TextView) (findViewById(com.run.sg.amap3d.R.id.title))).setText(titleId);
	}
	public synchronized void setTitleId(int titleId, boolean issub) {
		String title = this.getResources().getString(titleId);
		if (issub) {
			((TextView) (findViewById(com.run.sg.amap3d.R.id.title))).setText("         "+title);
		} else{
			((TextView) (findViewById(com.run.sg.amap3d.R.id.title))).setText(title);
		}
