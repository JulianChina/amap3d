package com.run.sg.amap3d.offlinemap;
...
//						Toast.LENGTH_SHORT).show()
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.offline_map_layout);
	...
	private void init() {
		...
		// 顶部
		mDownloadText = (TextView) findViewById(com.run.sg.amap3d.R.id.download_list_text);
		mDownloadedText = (TextView) findViewById(com.run.sg.amap3d.R.id.downloaded_list_text);

		mDownloadText.setOnClickListener(this);
		mDownloadedText.setOnClickListener(this);
		mBackImage = (ImageView) findViewById(com.run.sg.amap3d.R.id.back_image_view);
		mBackImage.setOnClickListener(this);

		// view pager 用到了所有城市list和已下载城市list所有放在最后初始化
		mContentViewPage = (ViewPager) findViewById(com.run.sg.amap3d.R.id.content_viewpage);
	...
	public void initAllCityList() {
		...
		View provinceContainer = LayoutInflater.from(OfflineMapActivity.this)
				.inflate(com.run.sg.amap3d.R.layout.offline_province_listview, null);
		mAllOfflineMapList = (ExpandableListView) provinceContainer
				.findViewById(com.run.sg.amap3d.R.id.province_download_list);
	...
	public void initDownloadedList() {
		mDownLoadedList = (ListView) LayoutInflater.from(
				...
				com.run.sg.amap3d.R.layout.offline_downloaded_list, null);
	...
	public void onCheckUpdate(boolean hasNew, String name) {
		// TODO Auto-generated method stub
		Log.i("amap-amap3d", "onCheckUpdate " + name + " : " + hasNew);
	...
	public void onRemove(boolean success, String name, String describe) {
		// TODO Auto-generated method stub
		Log.i("amap-amap3d", "onRemove " + name + " : " + success + " , "
				+ describe);
		handler.sendEmptyMessage(UPDATE_LIST);
	...
	public void onClick(View v) {
		if (v.equals(mDownloadText)) {
			...
			mDownloadText
					.setBackgroundResource(com.run.sg.amap3d.R.drawable.offlinearrow_tab1_pressed);

			mDownloadedText
					.setBackgroundResource(com.run.sg.amap3d.R.drawable.offlinearrow_tab2_normal);
			...
			mDownloadText
					.setBackgroundResource(com.run.sg.amap3d.R.drawable.offlinearrow_tab1_normal);
			mDownloadedText
					.setBackgroundResource(com.run.sg.amap3d.R.drawable.offlinearrow_tab2_pressed);
			mDownloadedText.setPadding(paddingHorizontal, paddingVertical,
					paddingHorizontal, paddingVertical);
			mDownloadText.setPadding(paddingHorizontal, paddingVertical,
					paddingHorizontal, paddingVertical);
