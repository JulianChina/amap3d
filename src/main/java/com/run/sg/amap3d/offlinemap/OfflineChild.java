...
public class OfflineChild implements OnClickListener, OnLongClickListener {
	...
	private void initView() {
		...
		mOffLineChildView = inflater.inflate(com.run.sg.amap3d.R.layout.offlinemap_child, null);
		mOffLineCityName = (TextView) mOffLineChildView.findViewById(com.run.sg.amap3d.R.id.name);
		mOffLineCitySize = (TextView) mOffLineChildView
				.findViewById(com.run.sg.amap3d.R.id.name_size);
		mDownloadImage = (ImageView) mOffLineChildView
				.findViewById(com.run.sg.amap3d.R.id.download_status_image);
		mDownloadProgress = (TextView) mOffLineChildView
				.findViewById(com.run.sg.amap3d.R.id.download_progress_status);
	...
	private void displayDefault() {
		...
		mDownloadImage.setImageResource(com.run.sg.amap3d.R.drawable.offlinearrow_download);
	}
	...
	private void displayWaitingStatus(int completeCode) {
		mDownloadProgress.setVisibility(View.VISIBLE);
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(com.run.sg.amap3d.R.drawable.offlinearrow_start);
	...
	private void displaySuccessStatus() {
		...
		mDownloadProgress.setTextColor(mContext.getResources().getColor(
				com.run.sg.amap3d.R.color.gary));
	}
	...
	private void displyaLoadingStatus(int completeCode) {
		...
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(com.run.sg.amap3d.R.drawable.offlinearrow_stop);
