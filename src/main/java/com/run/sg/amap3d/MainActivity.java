...
import com.run.sg.amap3d.basic.Animate_CameraActivity;
import com.run.sg.amap3d.basic.BasicMapActivity;
import com.run.sg.amap3d.basic.CameraActivity;
import com.run.sg.amap3d.basic.EventsActivity;
import com.run.sg.amap3d.basic.GestureSettingsActivity;
import com.run.sg.amap3d.basic.HeatMapActivity;
import com.run.sg.amap3d.basic.LayersActivity;
import com.run.sg.amap3d.basic.LimitBoundsActivity;
import com.run.sg.amap3d.basic.LogoSettingsActivity;
import com.run.sg.amap3d.basic.MapOptionActivity;
import com.run.sg.amap3d.basic.MinMaxZoomLevelActivity;
import com.run.sg.amap3d.basic.PoiClickActivity;
import com.run.sg.amap3d.basic.ScreenShotActivity;
import com.run.sg.amap3d.basic.TwoMapActivity;
import com.run.sg.amap3d.basic.UiSettingsActivity;
import com.run.sg.amap3d.basic.ViewPagerWithMapActivity;
import com.run.sg.amap3d.basic.ZoomActivity;
import com.run.sg.amap3d.basic.map.MapImpMethodActivity;
import com.run.sg.amap3d.busline.BusStationActivity;
import com.run.sg.amap3d.busline.BuslineActivity;
import com.run.sg.amap3d.cloud.CloudActivity;
import com.run.sg.amap3d.district.DistrictActivity;
import com.run.sg.amap3d.district.DistrictWithBoundaryActivity;
import com.run.sg.amap3d.geocoder.GeocoderActivity;
import com.run.sg.amap3d.geocoder.ReGeocoderActivity;
import com.run.sg.amap3d.indoor.IndoorMapActivity;
import com.run.sg.amap3d.inputtip.InputtipsActivity;
import com.run.sg.amap3d.location.CustomLocationActivity;
import com.run.sg.amap3d.location.LocationModeSourceActivity;
import com.run.sg.amap3d.location.LocationModeSourceActivity_Old;
import com.run.sg.amap3d.offlinemap.OfflineMapActivity;
import com.run.sg.amap3d.opengl.OpenglActivity;
import com.run.sg.amap3d.overlay.ArcActivity;
import com.run.sg.amap3d.overlay.CircleActivity;
import com.run.sg.amap3d.overlay.ColourfulPolylineActivity;
import com.run.sg.amap3d.overlay.CustomMarkerActivity;
import com.run.sg.amap3d.overlay.GeodesicActivity;
import com.run.sg.amap3d.overlay.GroundOverlayActivity;
import com.run.sg.amap3d.overlay.InfoWindowActivity;
import com.run.sg.amap3d.overlay.MarkerActivity;
import com.run.sg.amap3d.overlay.MarkerAnimationActivity;
import com.run.sg.amap3d.overlay.MarkerClickActivity;
import com.run.sg.amap3d.overlay.MultiPointOverlayActivity;
import com.run.sg.amap3d.overlay.NavigateArrowOverlayActivity;
import com.run.sg.amap3d.overlay.PolygonActivity;
import com.run.sg.amap3d.overlay.PolylineActivity;
import com.run.sg.amap3d.overlay.TileOverlayActivity;
import com.run.sg.amap3d.poisearch.PoiAroundSearchActivity;
import com.run.sg.amap3d.poisearch.PoiIDSearchActivity;
import com.run.sg.amap3d.poisearch.PoiKeywordSearchActivity;
import com.run.sg.amap3d.poisearch.SubPoiSearchActivity;
import com.run.sg.amap3d.route.BusRouteActivity;
import com.run.sg.amap3d.route.DriveRouteActivity;
import com.run.sg.amap3d.route.RideRouteActivity;
import com.run.sg.amap3d.route.RouteActivity;
import com.run.sg.amap3d.route.WalkRouteActivity;
import com.run.sg.amap3d.routepoi.RoutePOIActivity;
import com.run.sg.amap3d.share.ShareActivity;
import com.run.sg.amap3d.smooth.SmoothMoveActivity;
import com.run.sg.amap3d.tools.CalculateDistanceActivity;
import com.run.sg.amap3d.tools.ContainsActivity;
import com.run.sg.amap3d.tools.CoordConverActivity;
import com.run.sg.amap3d.tools.GeoToScreenActivity;
import com.run.sg.amap3d.trace.TraceActivity;
import com.run.sg.amap3d.view.FeatureView;
import com.run.sg.amap3d.weather.WeatherSearchActivity;
