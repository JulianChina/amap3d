package com.run.sg.amap3d.tools;
...
public class GeoToScreenActivity extends Activity implements OnMapClickListener, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.location2screen_activity);
	...
	private void init() {
		...
		latView = (EditText)findViewById(com.run.sg.amap3d.R.id.pointLat);
		lngView = (EditText)findViewById(com.run.sg.amap3d.R.id.pointLng);
		xView = (EditText)findViewById(com.run.sg.amap3d.R.id.pointX);
		yView = (EditText)findViewById(com.run.sg.amap3d.R.id.pointY);
		lnglat2pointBtn = (Button)findViewById(com.run.sg.amap3d.R.id.lnglat2pointbtn);
		point2LatlngBtn = (Button)findViewById(com.run.sg.amap3d.R.id.point2Latlngbtn);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case com.run.sg.amap3d.R.id.lnglat2pointbtn:
			toScreenLocation();
			break;
		case com.run.sg.amap3d.R.id.point2Latlngbtn:
			toGeoLocation();
			break;
		default:
			break;
