...
public class CoordConverActivity extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.convert_activity);
		init();
	 ...
	 */
	private void init() {
		selectcoord = (Spinner)findViewById(com.run.sg.amap3d.R.id.coord);
		...
		resultview = (TextView)findViewById(com.run.sg.amap3d.R.id.result);
