package com.run.sg.amap3d.geocoder;
...
public class ReGeocoderActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.geocoder_activity);
        /*
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
	...
	private void init() {
		...
		Button regeoButton = (Button) findViewById(com.run.sg.amap3d.R.id.geoButton);
		Button regeoButton_ = (Button)findViewById(com.run.sg.amap3d.R.id.regeoButton);
	...
	public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
		...
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getRegeocodeAddress() != null
				...
				ToastUtil.show(ReGeocoderActivity.this, com.run.sg.amap3d.R.string.no_result);
			}
		} else {
	...
	public void onClick(View v) {
		 ...
		 * 响应逆地理编码按钮
		 */
		case com.run.sg.amap3d.R.id.geoButton:
			getAddress(latLonPoint);
			break;
		case com.run.sg.amap3d.R.id.regeoButton:
			getAddresses();
		default:
			break;
		}
