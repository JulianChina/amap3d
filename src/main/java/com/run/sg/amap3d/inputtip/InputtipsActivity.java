package com.run.sg.amap3d.inputtip;
...
public class InputtipsActivity extends Activity implements TextWatcher, InputtipsListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.activity_inputtip);
		minputlist = (ListView)findViewById(com.run.sg.amap3d.R.id.inputlist);
		mKeywordText = (AutoCompleteTextView)findViewById(com.run.sg.amap3d.R.id.input_edittext);
