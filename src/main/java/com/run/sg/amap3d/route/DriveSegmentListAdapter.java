...
public class DriveSegmentListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, com.run.sg.amap3d.R.layout.item_bus_segment,
					null);
			holder.driveDirIcon = (ImageView) convertView
					.findViewById(com.run.sg.amap3d.R.id.bus_dir_icon);
			holder.driveLineName = (TextView) convertView
					.findViewById(com.run.sg.amap3d.R.id.bus_line_name);
			holder.driveDirUp = (ImageView) convertView
					.findViewById(com.run.sg.amap3d.R.id.bus_dir_icon_up);
			holder.driveDirDown = (ImageView) convertView
					.findViewById(com.run.sg.amap3d.R.id.bus_dir_icon_down);
			holder.splitLine = (ImageView) convertView
					.findViewById(com.run.sg.amap3d.R.id.bus_seg_split_line);
		...
		if (position == 0) {
			holder.driveDirIcon.setImageResource(com.run.sg.amap3d.R.drawable.dir_start);
			...
			holder.driveDirIcon.setImageResource(com.run.sg.amap3d.R.drawable.dir_end);
