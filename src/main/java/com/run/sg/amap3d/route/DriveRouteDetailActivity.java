...
public class DriveRouteDetailActivity extends Activity {
	...
	private void init() {
		...
		mTitleDriveRoute = (TextView) findViewById(com.run.sg.amap3d.R.id.firstline);
		mDesDriveRoute = (TextView) findViewById(com.run.sg.amap3d.R.id.secondline);
	...
	private void configureListView() {
		mDriveSegmentList = (ListView) findViewById(com.run.sg.amap3d.R.id.bus_segment_list);
