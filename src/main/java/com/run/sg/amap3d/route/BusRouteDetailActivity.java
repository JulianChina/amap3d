...
OnMapClickListener, InfoWindowAdapter, OnInfoWindowClickListener, OnMarkerClickListener {
	...
	private void init() {
		...
		mTitleBusRoute = (TextView) findViewById(com.run.sg.amap3d.R.id.firstline);
		mDesBusRoute = (TextView) findViewById(com.run.sg.amap3d.R.id.secondline);
		...
		mBusMap = (LinearLayout)findViewById(com.run.sg.amap3d.R.id.title_map);
		mBusMap.setVisibility(View.VISIBLE);
		mBuspathview = (LinearLayout)findViewById(com.run.sg.amap3d.R.id.bus_path);
		configureListView();
	}
	...
	private void configureListView() {
		mBusSegmentList = (ListView) findViewById(com.run.sg.amap3d.R.id.bus_segment_list);
