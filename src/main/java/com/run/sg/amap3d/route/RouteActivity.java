...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.run.sg.amap3d.R.layout.route_activity);
		
		mContext = this.getApplicationContext();
		mapView = (MapView) findViewById(com.run.sg.amap3d.R.id.route_map);
...
//		getIntentData();
	...
	private void init() {
		...
		mBusResultLayout = (LinearLayout) findViewById(com.run.sg.amap3d.R.id.bus_result);
		mRotueTimeDes = (TextView) findViewById(com.run.sg.amap3d.R.id.firstline);
		mRouteDetailDes = (TextView) findViewById(com.run.sg.amap3d.R.id.secondline);
		mDrive = (ImageView)findViewById(com.run.sg.amap3d.R.id.route_drive);
		mBus = (ImageView)findViewById(com.run.sg.amap3d.R.id.route_bus);
		mWalk = (ImageView)findViewById(com.run.sg.amap3d.R.id.route_walk);
		mBusResultList = (ListView) findViewById(com.run.sg.amap3d.R.id.bus_result_list);
	}
	...
	public void onBusClick(View view) {
		...
		mDrive.setImageResource(com.run.sg.amap3d.R.drawable.route_drive_normal);
		mBus.setImageResource(com.run.sg.amap3d.R.drawable.route_bus_select);
		mWalk.setImageResource(com.run.sg.amap3d.R.drawable.route_walk_normal);
	...
	public void onDriveClick(View view) {
		...
		mDrive.setImageResource(com.run.sg.amap3d.R.drawable.route_drive_select);
		mBus.setImageResource(com.run.sg.amap3d.R.drawable.route_bus_normal);
		mWalk.setImageResource(com.run.sg.amap3d.R.drawable.route_walk_normal);
	...
	public void onWalkClick(View view) {
		...
		mDrive.setImageResource(com.run.sg.amap3d.R.drawable.route_drive_normal);
		mBus.setImageResource(com.run.sg.amap3d.R.drawable.route_bus_normal);
		mWalk.setImageResource(com.run.sg.amap3d.R.drawable.route_walk_select);
		mapView.setVisibility(View.VISIBLE);
		mBusResultLayout.setVisibility(View.GONE);
	}
