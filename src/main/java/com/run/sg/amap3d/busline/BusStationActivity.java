package com.run.sg.amap3d.busline;
...
public class BusStationActivity extends Activity implements
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.run.sg.amap3d.R.layout.busline_activity);
	...
	private void init() {
		...
		Button searchByName = (Button) findViewById(com.run.sg.amap3d.R.id.searchbyname);
		searchByName.setText("公交站点查询");
		searchByName.setOnClickListener(this);
		selectCity = (Spinner) findViewById(com.run.sg.amap3d.R.id.cityName);
		...
		searchName = (EditText) findViewById(com.run.sg.amap3d.R.id.busName);
	...
	public void onBusStationSearched(BusStationResult result, int rCode) {
		...
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getPageCount() > 0
				...
				ToastUtil.show(BusStationActivity.this, com.run.sg.amap3d.R.string.no_result);
			}
		} else  {
