...
public class BusLineAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = layoutInflater.inflate(com.run.sg.amap3d.R.layout.busline_item, null);
			holder = new ViewHolder();
			holder.busName = (TextView) convertView.findViewById(com.run.sg.amap3d.R.id.busname);
			holder.busId = (TextView) convertView.findViewById(com.run.sg.amap3d.R.id.busid);
