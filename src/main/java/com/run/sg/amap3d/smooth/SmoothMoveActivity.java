package com.run.sg.amap3d.smooth;
...
import com.run.sg.amap3d.offlinemap.ToastUtil;
...
public class SmoothMoveActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.run.sg.amap3d.R.layout.activity_smooth_move);
    ...
    public void startMove(View view) {
        ...
        // 设置 平滑移动的 图标
        smoothMarker.setDescriptor(BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.icon_car));
    ...
    private View getInfoWindowView(Marker marker) {
        if (infoWindowLayout == null) {
            ...
            infoWindowLayout.setBackgroundResource(com.run.sg.amap3d.R.drawable.infowindow_bg);
    ...
    private void addPolylineInPlayGround() {
        ...
        textureList.add(BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.custtexture));
        ...
        mPolyline = mAMap.addPolyline(new PolylineOptions().setCustomTexture(BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.custtexture)) //setCustomTextureList(bitmapDescriptors)
