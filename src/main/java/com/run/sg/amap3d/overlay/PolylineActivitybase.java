...
import com.run.sg.amap3d.util.Constants;
...
public class PolylineActivitybase extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.polyline_activity);
        /*
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
	 ...
	 */
	private void init() {
		mColorBar = (SeekBar) findViewById(com.run.sg.amap3d.R.id.hueSeekBar);
		mColorBar.setMax(HUE_MAX);
		mColorBar.setProgress(50);

		mAlphaBar = (SeekBar) findViewById(com.run.sg.amap3d.R.id.alphaSeekBar);
		mAlphaBar.setMax(ALPHA_MAX);
		mAlphaBar.setProgress(255);

		mWidthBar = (SeekBar) findViewById(com.run.sg.amap3d.R.id.widthSeekBar);
...
//		addPolylineInPlayGround();
	...
	private void addPolylinesWithTexture() {
		...
		texTuresList.add(BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.map_alr));
		texTuresList.add(BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.custtexture));
		texTuresList.add(BitmapDescriptorFactory.fromResource(com.run.sg.amap3d.R.drawable.map_alr_night));
