...
public class DistrictWithBoundaryActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap3d.R.layout.district_boundary_activity);
		mButton = (Button) findViewById(com.run.sg.amap3d.R.id.search_button);
		mEditText = (EditText) findViewById(com.run.sg.amap3d.R.id.city_text);
