package com.run.sg.amap3d.weather;
...
public class WeatherSearchActivity extends Activity implements OnWeatherSearchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.run.sg.amap3d.R.layout.weather_activity);
        init();
        searchliveweather();
    ...
    private void init() {
        TextView city = (TextView) findViewById(com.run.sg.amap3d.R.id.city);
        city.setText(cityname);
        forecasttv = (TextView) findViewById(com.run.sg.amap3d.R.id.forecast);
        reporttime1 = (TextView) findViewById(com.run.sg.amap3d.R.id.reporttime1);
        reporttime2 = (TextView) findViewById(com.run.sg.amap3d.R.id.reporttime2);
        weather = (TextView) findViewById(com.run.sg.amap3d.R.id.weather);
        Temperature = (TextView) findViewById(com.run.sg.amap3d.R.id.temp);
        wind = (TextView) findViewById(com.run.sg.amap3d.R.id.wind);
        humidity = (TextView) findViewById(com.run.sg.amap3d.R.id.humidity);
    }
    ...
    public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
                ...
                ToastUtil.show(WeatherSearchActivity.this, com.run.sg.amap3d.R.string.no_result);
            }
        } else {
